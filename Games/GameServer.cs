...
namespace Game
{
    class GameServer
    {
        ...
        // Game stuff
        private Dictionary<TcpClient, IGames> _gameClientIsIn = new Dictionary<TcpClient, IGames>();
        private List<IGames> _games = new List<IGames>();
        private List<Thread> _gameThreads = new List<Thread>();
        private IGames _nextGame;
        ...
        public void Run()
        {
            ...
            _nextGame = new GuessMyNumber(this);
        ...
        public static GameServer gamesServer;
        ...
        public static void Main(string[] args)
        {
            ...
            gamesServer = new GameServer(name, port);
            gamesServer.Run();
        }
